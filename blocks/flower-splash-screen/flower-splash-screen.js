...
export default function decorate(block) {
  ...
  >
    ...
    >
      <img
        ...
        src="https://patinahotels.com/osaka/logo/flowerMask.svg"
  ...
  (() => {
    ...
    // Responsive: update isMobile and image src on resize
    const handleResize = () => {
      const newIsMobile = window.innerWidth <= 768;
      if (newIsMobile !== isMobile) {
        isMobile = newIsMobile;
        image.src = isMobile
          ? "https://dev-patina-site-aleph-labs.vercel.app/osaka/logo/Exclude.svg"
          : "https://dev-patina-site-aleph-labs.vercel.app/osaka/logo/flowerMask.svg";
        if (animationTimeline) animationTimeline.progress(1);
      }
    };
